...
MuncherFix = 1		;prevents thrown sprites from treating muncher as hit-able tile (and turning it into used block)
...
;!MUNCH
;removes those bytes for freespace
...
;!MUNCH
;Adds check for muncher tile

If MuncherFix
	CMP #TILEA_MUNCHER		;check if it's a muncher
	BEQ PRG008_B6FB
endif
    SEC
