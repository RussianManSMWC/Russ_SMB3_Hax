...
ClearPattern_ByTileset:
	...
	;!PlantJUMP
	;changed from -1 to -2 because of graphical glitch
PlantInfest_ACnt_MaxConst:  .byte (PlantInfest_PTPAC_End - PlantInfest_PatTablePerACnt - 2)
...
PlantFlag = $0500
    ...
    CMP #13;PlantInfest_ACnt_Max-1
    BEQ PRG030_8E13

	@DoInc
    INC PlantInfest_ACnt
	JMP PRG030_8E13
