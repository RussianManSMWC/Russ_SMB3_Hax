...
;!GOOMBA_SHOE
;Label Eject used for stomping (jump here)
...
;!GOOMBA_SHOE
;additional code - modifies stomp interaction. functions pretty much the same except it doesn't actually marks sprite as dead.
	
PRG002_B126:
    JSR HandleShoeStomp  		;special stomp handler
	JMP Eject					;eject goomba from shoe just like when bumping it from below
...
;!GOOMBA_SHOE
;removes this "whoops" opcode for a little bit of freespace. (3 bytes enough for JSR)
