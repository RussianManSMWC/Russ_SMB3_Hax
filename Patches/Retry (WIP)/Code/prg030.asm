...
;resets level when RETRY is chosen
;FIXME - sometimes marks previous completed level (player's supposed to skid to) as incomplete, seems random.
...
If EnableRetry
	...
	;do something if RETRY is chosen
	
	JMP PRG030_88C8		;call level load routine
	
	;PRG030_891A PRG030_87BD
	;PRG030_88C8 -> actual reload	
@Continue
endif
...
If EnableRetry
	...
	BNE PRG030_8F31		;don't run sprites/scrolling/etc.
endif
