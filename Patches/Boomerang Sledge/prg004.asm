...
;!SLEDGE_HACK
;Objects_Var7 - determines which extended sprite to throw depending on X-position
;check for X-position.
;odd - throw boomerangs
;even - throw hammers
...
;!SLEDGE_HACK
;makes use of misc. ram that determines extended sprite to throw
...
@ThrowBoomerang
	JSR BoomerangBro_ThrowBoomerang
else
