...
;!PayToWin
;check for coins and jump and stuff
JumpCoin:
LDA Player_InWater
BEQ @CheckOthers
...
@CheckInput
    LDX #00    ; Y = offset to Mario's coins

    LDY Player_Current
    BEQ @Player  ; If Player is Mario, jump to PRG030_92FE

	;incorrect
    LDX #Inventory_Coins2 - Inventory_Coins   ; Y = offset to Luigi's coins
...
@YesCoin
DEC Inventory_Coins,x		;doesn't exist?


    LDA Sound_QPlayer				;moved from bank 8
    ORA #SND_PLAYERJUMP
    STA Sound_QPlayer
JMP JumpCoin_After
